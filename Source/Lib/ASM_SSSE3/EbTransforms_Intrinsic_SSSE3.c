...
extern "C" const int16_t coeff_tbl2[48 * 8];
#else
...
static uint32_t transpose16Check0s(int16_t *src, uint32_t src_stride, int16_t *dst, uint32_t dst_stride)
{
    uint32_t i, j;
    uint32_t zeroPattern = 0;
    uint32_t result = 0;
...
static void transform16(int16_t *src, uint32_t src_stride, int16_t *dst, uint32_t dst_stride, int16_t shift)
{
    uint32_t i;
...
static void transpose32(int16_t *src, uint32_t src_stride, int16_t *dst, uint32_t dst_stride)
{
    uint32_t i, j;
    for (i = 0; i < 4; i++)
    {
...
static uint32_t transpose32Check0s(int16_t *src, uint32_t src_stride, int16_t *dst, uint32_t dst_stride)
{
    uint32_t i, j;
    uint32_t zeroPattern = 0;
    uint32_t result = 0;
...
static void invTransform32Partial(int16_t *src, uint32_t src_stride, int16_t *dst, uint32_t dst_stride, uint32_t shift, uint32_t pattern)
{
    uint32_t numRows = 32 - 2 * (pattern & 12);
    ...
    uint32_t          *nonzerocoeff)
{
    ...
    do
    {
        ...
        int32_t msk = _mm_movemask_epi8(cmp);
