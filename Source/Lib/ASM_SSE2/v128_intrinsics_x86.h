...
#if defined(__SSSE3__)
SIMD_INLINE v128 v128_align(v128 a, v128 b, uint32_t c) {
...
SIMD_INLINE v128 v128_shl_16(v128 a, uint32_t c) {
    return _mm_sll_epi16(a, _mm_cvtsi32_si128(c));
}

SIMD_INLINE v128 v128_shr_u16(v128 a, uint32_t c) {
    return _mm_srl_epi16(a, _mm_cvtsi32_si128(c));
}

SIMD_INLINE v128 v128_shr_s16(v128 a, uint32_t c) {
    return _mm_sra_epi16(a, _mm_cvtsi32_si128(c));
}

SIMD_INLINE v128 v128_shl_32(v128 a, uint32_t c) {
    return _mm_sll_epi32(a, _mm_cvtsi32_si128(c));
}

SIMD_INLINE v128 v128_shr_u32(v128 a, uint32_t c) {
    return _mm_srl_epi32(a, _mm_cvtsi32_si128(c));
}

SIMD_INLINE v128 v128_shr_s32(v128 a, uint32_t c) {
