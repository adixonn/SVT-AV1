...
static void highbd_warp_plane(EbWarpedMotionParams *wm, const uint8_t *const ref8,
...
static int64_t highbd_warp_error(
    EbWarpedMotionParams *wm, const uint8_t *const ref8, int width, int height,
...
static int64_t warp_error(EbWarpedMotionParams *wm, const uint8_t *const ref,
                          int width, int height, int stride,
