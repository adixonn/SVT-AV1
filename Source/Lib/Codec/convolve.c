...
static INLINE int32_t highbd_horz_scalar_product(const uint16_t *a,
    const int16_t *b) {
    int32_t sum = 0;
    for (int32_t k = 0; k < SUBPEL_TAPS; ++k) sum += a[k] * b[k];
    return sum;
...
static INLINE int32_t highbd_vert_scalar_product(const uint16_t *a,
    ptrdiff_t a_stride,
    const int16_t *b) {
    int32_t sum = 0;
...
static void highbd_convolve_add_src_horiz_hip(
    ...
    int32_t x_step_q4, int32_t w, int32_t h, int32_t round0_bits, int32_t bd) {
...
static void highbd_convolve_add_src_vert_hip(
    ...
    int32_t y_step_q4, int32_t w, int32_t h, int32_t round1_bits, int32_t bd) {
